...
namespace Kiota.Builder.Tests {
    public class CodeMethodTests {
        ...
        public void Defensive() {
            ...
            Assert.Throws<ArgumentNullException>(() => method.DiscriminatorInformation.AddDiscriminatorMapping(null, new CodeType{Name = "class"}));
            Assert.Throws<ArgumentNullException>(() => method.DiscriminatorInformation.AddDiscriminatorMapping("oin", null));
            Assert.Throws<ArgumentNullException>(() => method.DiscriminatorInformation.GetDiscriminatorMappingValue(null));
            Assert.Null(method.DiscriminatorInformation.GetDiscriminatorMappingValue("oin"));
