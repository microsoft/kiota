  ...
  schemas:
    ...
    StorageAccountType:
      ...
      x-ms-enum:
        ...
        Assert.Equal("minus_1", firstOption.Name);
        ...
        Assert.Equal("plus_1", secondOption.Name);
        Assert.Empty(secondOption.Documentation.Description);
        var thirdOption = enumDef.FindChildByName<CodeEnumOption>("StandardLocalRedundancy", false);
