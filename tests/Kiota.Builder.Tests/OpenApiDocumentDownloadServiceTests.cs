...
""");
        ...
        await Assert.ThrowsAsync<InvalidOperationException>(() =>
            documentDownloadService.GetDocumentFromStreamAsync(inputDocumentStream, generationConfig, cancellationToken: CancellationToken.None));
    }
...
""");
        ...
        var document = await documentDownloadService.GetDocumentFromStreamAsync(inputDocumentStream, generationConfig, cancellationToken: CancellationToken.None);
    ...
    public async Task AllowedExternalOriginsStreamLoaderAllowsFullLocalPaths()
    {
        ...
        try
        {
            ...
            await File.WriteAllTextAsync(schemaPath, "type: object", CancellationToken.None);
            using var httpClient = new HttpClient(new ResponseHandler());
