...
RSpec.describe MicrosoftKiotaAuthentication do
  it 'initializes empty allowed hosts properly' do
    ahv = MicrosoftKiotaAuthentication::AllowedHostsValidator.new([])
    expect(ahv.allowed_hosts).to eq([])
  end

  it 'initializes non-empty/cased allowed hosts properly' do
    ahv = MicrosoftKiotaAuthentication::AllowedHostsValidator.new(['microsoft.com', 'Graph.microsoft.com', 'DOD-graph.microsoft.us'])
  ...
  it 'tests url_host_valid? method on malformed and valid urls' do
    ahv = MicrosoftKiotaAuthentication::AllowedHostsValidator.new(['www.google.com', 'example.com', 'Graph.microsoft.com',
