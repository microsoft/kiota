...
public class TableOutputFormatterTest
{
    ...
    public class ConstructTableAsyncFunction_Should {
        [Fact]
        public async Task Create_A_Table_With_Single_Column_And_Row_When_Object_With_Value()
        {
            var console = new TestConsole();
            var formatter = new TableOutputFormatter();
            var content = "{\"x\": \"\", \"value\": 10}";
            ...
            var table = await formatter.ConstructTableAsync(doc);
        ...
        [Fact]
        public async Task Create_A_Table_Given_A_JSON_Array()
        {
            var console = new TestConsole();
            var formatter = new TableOutputFormatter();
            var content = "[{\"a\": \"value a\", \"b\": null, \"c\": \"value c\"}, {\"a\": \"value a\", \"b\": \"value b\", \"c\": null}]";
        ...
        [Fact]
        public async Task Create_A_Table_Given_A_JSON_Object_With_Value_Array()
        {
            var console = new TestConsole();
            var formatter = new TableOutputFormatter();
            var content = "{\"value\": [{\"a\": \"value a\", \"b\": null, \"c\": \"value c\"}, {\"a\": \"value a\", \"b\": \"value b\", \"c\": null}]}";
        ...
        [Fact]
        public async Task Create_A_Table_Given_An_Array_Of_Non_Object_Values()
        {
            var console = new TestConsole();
            var formatter = new TableOutputFormatter();
            var content = "[1, 2, 3, 4, 5, [10, 11]]";
        ...
        [Fact]
        public async Task Create_A_Table_Given_A_Scalar_Values()
        {
            var console = new TestConsole();
            var formatter = new TableOutputFormatter();
            var content = "1";
