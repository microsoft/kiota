...
#pragma warning restore CA2007
        ...
        if (!cancellationToken.IsCancellationRequested)
            await sw.FlushAsync(cancellationToken).ConfigureAwait(false); // stream writer doesn't not have a cancellation token overload https://github.com/dotnet/runtime/issues/64340
    }
    ...
    public virtual bool ShouldRenderNamespaceFile(CodeNamespace codeNamespace)
    {
        ...
        var namespaceNameLastSegment = codeNamespace.Name.Split('.')[^1];
