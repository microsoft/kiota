...
public class CrystalPathSegmenter : CommonPathSegmenter
{
    public CrystalPathSegmenter(string rootPath, string clientNamespaceName) : base(rootPath, clientNamespaceName) { }
    ...
    public override string FileSuffix => ".cr";
