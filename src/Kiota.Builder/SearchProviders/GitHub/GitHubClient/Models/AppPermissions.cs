...
public class AppPermissions : IAdditionalDataHolder, IParsable
{
    ...
    public AppPermissions_organization_administration? Organization_administration
    {
        get; set;
    }
    ...
    public AppPermissions_organization_announcement_banners? Organization_announcement_banners
    {
        get; set;
    }
    ...
    public AppPermissions_organization_projects? Organization_projects
    {
        get; set;
    }
    /// <summary>The level of permission to grant the access token to manage organization secrets.</summary>
    public AppPermissions_organization_secrets? Organization_secrets
    {
        get; set;
    }
    ...
    public AppPermissions_organization_self_hosted_runners? Organization_self_hosted_runners
    {
        get; set;
    }
    /// <summary>The level of permission to grant the access token to view and manage users blocked by the organization.</summary>
    public AppPermissions_organization_user_blocking? Organization_user_blocking
    {
        get; set;
    }
    ...
    public AppPermissions_pull_requests? Pull_requests
    {
        get; set;
    }
    ...
    public AppPermissions_security_events? Security_events
    {
        get; set;
    }
    /// <summary>The level of permission to grant the access token to manage just a single file.</summary>
    public AppPermissions_single_file? Single_file
    {
        get; set;
    }
    ...
    public AppPermissions_team_discussions? Team_discussions
    {
        get; set;
    }
    /// <summary>The level of permission to grant the access token to manage Dependabot alerts.</summary>
    public AppPermissions_vulnerability_alerts? Vulnerability_alerts
    {
        get; set;
    }
