...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<Repositories_matches>? Matches { get; set; }
#nullable restore
#else
        public List<Repositories_matches> Matches { get; set; }
#endif
...
#nullable restore
        ...
        public IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"matches", n => { Matches = n.GetCollectionOfObjectValues<Repositories_matches>(Repositories_matches.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<Repositories_matches>("matches", Matches);
