...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<Repositories>? TextMatches { get; set; }
#nullable restore
#else
        public List<Repositories> TextMatches { get; set; }
#endif
...
#nullable restore
        ...
        public IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"text_matches", n => { TextMatches = n.GetCollectionOfObjectValues<Repositories>(Repositories.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<Repositories>("text_matches", TextMatches);
