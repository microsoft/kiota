...
#nullable restore
        ...
        /// </summary>
        public class Repositories : IComposedTypeWrapper, IParsable {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
            public string? RepositoriesString { get; set; }
#nullable restore
#else
            public string RepositoriesString { get; set; }
#endif
...
#nullable restore
            ...
            public static Repositories CreateFromDiscriminatorValue(IParseNode parseNode) {
                ...
                else if(parseNode.GetStringValue() is string repositoriesStringValue) {
                    result.RepositoriesString = repositoriesStringValue;
                }
            ...
            public void Serialize(ISerializationWriter writer) {
                ...
                else if(RepositoriesString != null) {
                    writer.WriteStringValue(null, RepositoriesString);
                }
                else if(String != null) {
