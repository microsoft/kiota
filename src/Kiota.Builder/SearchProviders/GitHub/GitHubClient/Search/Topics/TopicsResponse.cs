...
namespace Kiota.Builder.SearchProviders.GitHub.GitHubClient.Search.Topics {
    public class TopicsResponse : IAdditionalDataHolder, IParsable {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>The incomplete_results property</summary>
        public bool? Incomplete_results { get; set; }
        /// <summary>The items property</summary>
        public List<TopicSearchResultItem> Items { get; set; }
        /// <summary>The total_count property</summary>
        public int? Total_count { get; set; }
        /// <summary>
        /// Instantiates a new topicsResponse and sets the default values.
        /// </summary>
        ...
        public static TopicsResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"items", n => { Items = n.GetCollectionOfObjectValues<TopicSearchResultItem>(TopicSearchResultItem.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<TopicSearchResultItem>("items", Items);
