...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ContentFile?> GetAsync(Action<WithPathItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<ContentFile> GetAsync(Action<WithPathItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
...
#nullable restore
        ...
        /// <summary>
        /// Composed type wrapper for classes contentFile, contentSubmodule, contentSymlink, WithPathResponseMember1
        /// </summary>
        public class WithPathResponse : IComposedTypeWrapper, IParsable
        {
