...
public class CodeFile : CodeBlock<CodeFileDeclaration, CodeFileBlockEnd>
{
    ...
    {
        get => InnerChildElements.Values.OfType<CodeInterface>().ToDictionary(static x => x.Name, static x => x);
    }
    [JsonIgnore]
    ...
    {
        get => InnerChildElements.Values.OfType<CodeClass>().ToDictionary(static x => x.Name, static x => x);
    }
    [JsonIgnore]
    ...
    {
        get => InnerChildElements.Values.OfType<CodeEnum>().ToDictionary(static x => x.Name, static x => x);
    }
    [JsonIgnore]
    ...
    {
        get => InnerChildElements.Values.OfType<CodeConstant>().ToDictionary(static x => x.Name, static x => x);
    }
    [JsonIgnore]
    ...
    {
        get => InnerChildElements.Values.OfType<CodeFunction>().ToDictionary(static x => x.Name, static x => x);
    }
    [JsonIgnore]
