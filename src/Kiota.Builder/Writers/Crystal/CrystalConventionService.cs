...
namespace Kiota.Builder.Writers.Crystal
{
    public class CrystalConventionService : CommonLanguageConventionService
    {
        ...
        public override string TempDictionaryVarName => "temp_hash";
        public override string ParseNodeInterfaceName => "IParseNode";
        public string KeyValuePairInterfaceName => "Hash";
        public string DictionaryInterfaceName => "Hash";
        ...
        public override string TranslateType(CodeType type)
        {
            ...
            return type.Name switch
            {
                ...
                "IDictionary" or "Dictionary" => "Hash",
                "IKeyValuePair" or "KeyValuePair" => "Hash",
                "ICollection" or "Collection" => "Array",
                "IList" or "List" => "Array",
                "DateTimeOffset" or "DateTime" => "Time",
        ...
        public override bool WriteShortDescription(IDocumentedElement element, LanguageWriter writer, string prefix = "", string suffix = "")
        {
            ...
            {
                var typeFunc = new Func<CodeTypeBase, string>(type => GetTypeStringForDocumentation(type, codeElement));
                var description = element.Documentation.GetDescription(typeFunc, 
                    normalizationFunc: static x => System.Net.WebUtility.HtmlDecode(x.CleanupXMLString()));
        ...
        public bool WriteLongDescription(IDocumentedElement element, LanguageWriter writer, string prefix = "", string suffix = "")
        {
            ...
            if (documentation.DescriptionAvailable || documentation.ExternalDocumentationAvailable)
            {
                ...
                {
                    var typeFunc = new Func<CodeTypeBase, string>(type => GetTypeStringForDocumentation(type, codeElement));
                    var description = element.Documentation.GetDescription(typeFunc, normalizationFunc: static x => x.CleanupXMLString());
        ...
        public void WriteDeprecationAttribute(IDeprecableElement element, LanguageWriter writer)
        {
            ...
            if (element?.Deprecation != null)
            {
                var codeElement = element as CodeElement;
                var typeFunc = new Func<CodeTypeBase, string>(type => GetTypeStringForDocumentation(type, codeElement ?? throw new ArgumentNullException(nameof(element))));
                var description = element.Deprecation.GetDescription(typeFunc);
                if (!string.IsNullOrEmpty(description))
                {
