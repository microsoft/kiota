...
namespace Kiota.Builder.Writers.CSharp {
    public class CodeClassDeclarationWriter : BaseElementWriter<ClassDeclaration, CSharpConventionService>
    {
        ...
        protected void WriteNamespaces(ClassDeclaration codeElement, LanguageWriter writer)
        {
            codeElement.Usings
        ...
        protected void WriteClassProptotype(ClassDeclaration codeElement, LanguageWriter writer)
        {
        ...
        protected void WriteSummary(ClassDeclaration codeElement, LanguageWriter writer)
        {
