...
{
    private readonly string _clientClassAccessModifier;
    ...
    public CodeClassDeclarationWriter(CSharpConventionService conventionService, string? clientClassAccessModifier) : base(conventionService)
    {
        _clientClassAccessModifier = string.IsNullOrWhiteSpace(clientClassAccessModifier) ? "public" : clientClassAccessModifier;
    }
