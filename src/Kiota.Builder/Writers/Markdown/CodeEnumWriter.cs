...
namespace Kiota.Builder.Writers.Markdown {
    public class CodeEnumWriter : BaseElementWriter<CodeEnum, MarkdownConventionService>
    {
        public CodeEnumWriter(MarkdownConventionService conventionService):base(conventionService) {}
