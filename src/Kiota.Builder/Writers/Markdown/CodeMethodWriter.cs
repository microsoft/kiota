...
public class CodeMethodWriter : BaseElementWriter<CodeMethod, MarkdownConventionService>
{
    ...
    private string GetDeserializationMethodName(CodeTypeBase propType, CodeMethod method)
    {
        ...
        return propertyType switch
        {
            ...
            _ when conventions.IsPrimitiveType(propertyType) => $"Get{propertyType.TrimEnd(MarkdownConventionService.NullableMarker).ToFirstCharacterUpperCase()}Value()",
    ...
    private string GetSerializationMethodName(CodeTypeBase propType, CodeMethod method)
    {
        ...
        return propertyType switch
        {
            ...
            _ when conventions.IsPrimitiveType(propertyType) => $"Write{propertyType.TrimEnd(MarkdownConventionService.NullableMarker).ToFirstCharacterUpperCase()}Value",
