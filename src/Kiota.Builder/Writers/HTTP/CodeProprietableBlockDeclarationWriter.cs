...
public abstract class CodeProprietableBlockDeclarationWriter<T> : BaseElementWriter<T, HttpConventionService>
    where T : ProprietableBlockDeclaration
{
    protected CodeProprietableBlockDeclarationWriter(HttpConventionService conventionService) : base(conventionService) { }
