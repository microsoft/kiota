...
public class CodePropertyWriter : BaseElementWriter<CodeProperty, HttpConventionService>
{
    public CodePropertyWriter(HttpConventionService conventionService) : base(conventionService) { }
