...
{
    public static Command GetWorkspaceNodeCommand(IServiceProvider? serviceProvider = null)
    {
    ...
    private static Command GetInitCommand(IServiceProvider? serviceProvider = null)
    {
    ...
    private static Command GetMigrateCommand(IServiceProvider? serviceProvider = null)
    {
        var logLevelOption = KiotaHost.GetLogLevelOption();
