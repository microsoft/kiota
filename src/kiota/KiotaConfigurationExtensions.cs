...
internal static class KiotaConfigurationExtensions
{
    ...
    public static void BindConfiguration(this KiotaConfiguration configObject, IConfigurationRoot configuration)
    {
        ...
        configObject.Generation.ClientClassAccessModifier = configuration[$"{nameof(configObject.Generation)}:{nameof(GenerationConfiguration.ClientClassAccessModifier)}"] is string clientClassAccessModifier && !string.IsNullOrEmpty(clientClassAccessModifier) ? clientClassAccessModifier : configObject.Generation.ClientClassAccessModifier;
