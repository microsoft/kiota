...
public static partial class KiotaHost
{
    ...
    public static RootCommand GetRootCommand(IServiceProvider? serviceProvider = null)
    {
    ...
    private static Command GetGitHubLoginCommand(IServiceProvider? serviceProvider = null)
    {
    ...
    private static Command GetGitHubDeviceLoginCommand(IServiceProvider? serviceProvider = null)
    {
    ...
    private static Command GetGitHubPatLoginCommand(IServiceProvider? serviceProvider = null)
    {
        var logLevelOption = GetLogLevelOption();
    ...
    private static Command GetGitHubLogoutCommand(IServiceProvider? serviceProvider = null)
    {
        var logLevelOption = GetLogLevelOption();
    ...
    private static Command GetLoginCommand(IServiceProvider? serviceProvider = null)
    {
    ...
    private static Command GetLogoutCommand(IServiceProvider? serviceProvider = null)
    {
        var loginCommand = new Command("logout", "Logs out of Kiota registries.");
        loginCommand.Add(GetGitHubLogoutCommand(serviceProvider));
        return loginCommand;
    }
    private static Command GetInfoCommand(IServiceProvider? serviceProvider = null)
    {
    ...
    private static Command GetShowCommand(IServiceProvider? serviceProvider = null)
    {
        var defaultGenerationConfiguration = new GenerationConfiguration();
        var descriptionOption = GetDescriptionOption(defaultGenerationConfiguration.OpenAPIFilePath);
        var manifestOption = GetManifestOption(defaultGenerationConfiguration.ApiManifestPath);
    ...
    internal static Command GetRpcCommand(IServiceProvider? serviceProvider = null)
    {
    ...
    private static Command GetDownloadCommand(IServiceProvider? serviceProvider = null)
    {
    ...
    private static Command GetSearchCommand(IServiceProvider? serviceProvider = null)
    {
    ...
    private static Command GetGenerateCommand(IServiceProvider? serviceProvider = null)
    {
    ...
    private static Command GetUpdateCommand(IServiceProvider? serviceProvider = null)
    {
        var defaultConfiguration = new GenerationConfiguration();
        var outputOption = GetOutputPathOption(defaultConfiguration.OutputPath);
