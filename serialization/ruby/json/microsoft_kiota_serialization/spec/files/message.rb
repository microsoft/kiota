    ...
    class Message < OutlookItem
        ...
        def get_field_deserializers() 
            return super.merge({
                ...
                "bccRecipients" => lambda {|n| @bcc_recipients = n.get_collection_of_object_values(Files::Recipient) },
                "body" => lambda {|n| @body = n.get_object_value(Files::ItemBody) },
                "bodyPreview" => lambda {|n| @body_preview = n.get_string_value() },
                "ccRecipients" => lambda {|n| @cc_recipients = n.get_collection_of_object_values(Files::Recipient) },
                ...
                "from" => lambda {|n| @from = n.get_object_value(Files::Recipient) },
                ...
                "replyTo" => lambda {|n| @reply_to = n.get_collection_of_object_values(Files::Recipient) },
                "sender" => lambda {|n| @sender = n.get_object_value(Files::Recipient) },
                "sentDateTime" => lambda {|n| @sent_date_time = n.get_date_time_value() },
                "subject" => lambda {|n| @subject = n.get_string_value() },
                "toRecipients" => lambda {|n| @to_recipients = n.get_collection_of_object_values(Files::Recipient) },
                "uniqueBody" => lambda {|n| @unique_body = n.get_object_value(Files::ItemBody) },
