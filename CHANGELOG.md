...
- C#, Java, Go and PHP client: default value initialization in model classes for DateTime/Date/Time properties did not compile [#7404](https://github.com/microsoft/kiota/issues/7404)
