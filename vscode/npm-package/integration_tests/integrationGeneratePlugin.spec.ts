...
describe("GeneratePlugin", () => {
  ...
  test('generatePlugin_withSecurity', async () => {
    ...
    expect(actualPluginManifest?.runtime[0].auth.reference_id).toEqual('{oAuth2AuthCode_CONFIGURATION_ID}');
    ...
    expect(actualSecurityScheme.referenceId).toEqual('{oAuth2AuthCode_CONFIGURATION_ID}');
  });
